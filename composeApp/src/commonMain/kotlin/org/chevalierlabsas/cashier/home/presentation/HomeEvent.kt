...
sealed interface HomeEvent {
    ...
    data object ShowRegistrationSheet: HomeEvent
    data class CreateUserName(val name: String): HomeEvent
    data class OnRegistrationNameChanged(val name: String): HomeEvent
